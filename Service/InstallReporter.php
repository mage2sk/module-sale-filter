<?php
/**
 * Standalone install + heartbeat reporter for Panth_SaleFilter.
 *
...
namespace Panth\SaleFilter\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_SaleFilter';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-sale-filter';
